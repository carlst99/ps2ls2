...
namespace ps2ls.Assets
{
    ...
    {
        //This is a reimplementation of the work done in https://github.com/brhumphe/dbg-pack and https://github.com/RhettVX/forgelight-toolbox/tree/master/FLUtils
        ...
        {
            new NamelistGenerator().GenerateNameListInternal(getPacks, useRegex);
        }
        ...
        private byte[] CreateBufferFromAsset(AssetLite asset, FileStream packFileStream)
        {
            ...
            if (asset.isZipped)
                buffer = Pack.Decompress(expectedLength, buffer);
